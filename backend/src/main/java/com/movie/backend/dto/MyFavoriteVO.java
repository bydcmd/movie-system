...
@Data
@Schema(description = "我的收藏记录 (包含电影信息和收藏时间)")
public class MyFavoriteVO {
    ...
    @Schema(description = "电影封面URL", example = "http://localhost:8080/images/p480747492.jpg")
    ...
    @Schema(description = "评分人数", example = "2956885")
    ...
    @Schema(description = "演员列表", example = "[{\"name\":\"蒂姆·罗宾斯\",\"id\":\"12345\"}]")
    ...
    @Schema(description = "收藏时间", example = "2024-01-15 14:30:00")
